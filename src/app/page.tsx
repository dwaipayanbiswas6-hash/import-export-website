        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-16 lg:grid-cols-[1.1fr_.9fr]">
          ...
          >
            ...
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/70 md:text-xl">
              Helping overseas B2B buyers explore quality Indian products with
              clear communication, responsible sourcing and professional export
              coordination.
            </p>
        ...
        <div className="mx-auto grid max-w-7xl gap-14 lg:grid-cols-[.85fr_1.15fr] lg:items-center">
          <Reveal className="relative min-h-[460px] overflow-hidden rounded-[2rem] bg-cream p-8">
            ...
            <div className="relative flex h-full flex-col justify-between">
              <p
                className="font-display text-8xl text-gold/30"
                aria-hidden="true"
              >
                BE
              </p>
              <div>
                <p className="max-w-sm font-display text-5xl font-semibold leading-tight text-navy">
                  Indian sourcing. Global outlook.
                </p>
                <p className="mt-5 text-sm font-bold uppercase tracking-[0.22em] text-slate-500">
                  Merchant Export Company · Asansol
                </p>
              </div>
            </div>
          </Reveal>
          <div>
            ...
            <p className="mt-5 leading-7 text-slate-600">
              We identify suitable manufacturers, processors, farmers and
              suppliers across India based on each buyer’s requirements, with a
              clear focus on transparency, reliability and shared business
              value.
            </p>
