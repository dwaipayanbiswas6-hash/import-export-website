...
export const siteConfig = {
  ...
  whatsappHref: 'https://wa.me/917908622788',
...
export const products = [
  ...
  },
  {
    ...
    category: 'Food & Agriculture',
    description:
      'Requirement-led sourcing opportunities from suitable Indian processors and suppliers.',
  },
  {
...
export const aboutCopy = [
  'Biswas Exports is a merchant export company based in Asansol, West Bengal, India. We help international buyers explore quality Indian products through responsible sourcing, professional coordination and dependable service.',
  'Our approach begins with the buyer’s exact requirement. We identify suitable manufacturers, processors, farmers and suppliers across India, coordinate product and commercial information, and maintain clear communication at every stage.',
  'Biswas Exports is focused on becoming a trusted bridge between Indian producers and global markets by creating value through transparency, reliability and long-term business relationships.',
];
